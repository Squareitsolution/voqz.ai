  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-gray-300">
      ...
      >
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-12 text-center relative z-10 bg-slate-800">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              About Us
            </h2>
            <p className="text-gray-200 text-lg leading-relaxed mx-auto">
              At <span className="text-teal-400 font-semibold">VOQZ</span>, we
              are redefining how businesses communicate through cutting-edge{" "}
              <span className="text-cyan-400 font-semibold">Voice AI</span>. Our
              platform empowers companies to automate conversations, enhance
              customer experiences, and accelerate growth — all through the
              power of intelligent voice interaction.
            </p>
          </div>
        </section>

        {/* 🌀 Our Story Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-12 relative z-10 bg-slate-300 ">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                VOQZ began as a small team passionate about AI and has grown
                into a leading voice-automation provider. Our vision was simple:
                make AI conversations so natural that customers couldn't tell
                the difference—and ensure businesses never lose opportunities to
                missed calls.
              </p>
            </div>
          </div>
        ...
        <section className="py-20 text-center bg-gradient-to-r from-teal-600 flex flex-col to-cyan-500 relative z-10">
          ...
          <Link
            to="/contact"
            className="px-8 py-3 bg-white text-teal-600 font-semibold rounded-full flex justify-center gap-2 mx-auto hover:bg-gray-100 transition-all"
          >
